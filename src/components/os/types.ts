...
export const APP_DEFINITIONS: AppDefinition[] = [
  ...
  { id: 'mcp-servers', title: 'MCP Servers', iconName: 'Plug', color: 'neon-purple', defaultWidth: 1000, defaultHeight: 680, minWidth: 650, minHeight: 450, desktopIcon: true, category: 'system' },
  ...
  { id: 'codeeditor', title: 'Code Editor', iconName: 'FileCode', color: 'neon-blue', defaultWidth: 1100, defaultHeight: 750, minWidth: 700, minHeight: 500, desktopIcon: true, category: 'system' },
  { id: 'jupyter-lab', title: 'Jupyter Notebook', iconName: 'Code2', color: 'orange-400', defaultWidth: 1100, defaultHeight: 750, minWidth: 700, minHeight: 500, desktopIcon: true, category: 'tools' },
  { id: 'live-playground', title: 'Live Playground', iconName: 'Play', color: 'neon-cyan', defaultWidth: 1100, defaultHeight: 750, minWidth: 700, minHeight: 500, desktopIcon: true, category: 'tools' },
  { id: 'doc-studio', title: 'Doc Studio', iconName: 'FileText', color: 'neon-blue', defaultWidth: 1050, defaultHeight: 700, minWidth: 650, minHeight: 450, desktopIcon: true, category: 'tools' },
  { id: 'database-studio', title: 'Database SQL Studio', iconName: 'Database', color: 'emerald-400', defaultWidth: 1050, defaultHeight: 700, minWidth: 650, minHeight: 450, desktopIcon: true, category: 'tools' },
  { id: 'api-lab', title: 'API Lab', iconName: 'Globe', color: 'neon-purple', defaultWidth: 1000, defaultHeight: 700, minWidth: 650, minHeight: 450, desktopIcon: true, category: 'tools' },
  ...
  { id: 'terminal', title: 'Terminal', iconName: 'Terminal', color: 'neon-green', defaultWidth: 750, defaultHeight: 500, minWidth: 450, minHeight: 300, desktopIcon: true, category: 'system' },
  { id: 'balance', title: 'Planos & Faturamento', iconName: 'Wallet', color: 'emerald-400', defaultWidth: 1000, defaultHeight: 720, minWidth: 650, minHeight: 450, desktopIcon: true, category: 'tools' },
