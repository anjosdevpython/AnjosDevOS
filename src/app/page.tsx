...
export default function HomePage() {
  ...
  return (
    <OSProvider>
      ...
      <div className="fixed top-2 right-3 z-[99999] flex items-center p-1 bg-[#0c101d]/90 backdrop-blur-2xl border border-white/15 rounded-full shadow-[0_10px_25px_rgba(0,0,0,0.6)]">
        ...
        <button
          ...
          className={cn(
            ...
            uiMode === 'macos'
              ? 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-[0_0_15px_rgba(59,130,246,0.5)] font-bold'
